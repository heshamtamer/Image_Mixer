...
class MainApp(QMainWindow , FORM_CLASS):
    ...
    def mix_arrays(self):
        try:
            ...
            if mode == "Mag/Phase":  # Magnitude-Phase
                self.mixed_array = mixer.mix_magnitude_phase(array21, array22, array23, array24, index_1, index_2, index_3,
                                                       index_4,weights,dims,roi)
            elif mode == "Real/Imag":  # Real-Imaginary
                self.mixed_array = mixer.mix_real_imaginary(array21, array22, array23, array24,index_1, index_2, index_3,
                                                       index_4,weights,dims,roi)
                
            # # Start the delay timer with a 1000 ms (1 seconds) timeout
            # self.progress_value = 0
            # self.delay_timer.start(2000)

            # # Update the progress bar while waiting for the delay
            # self.delay_timer.timeout.connect(self.update_progress_bar)
    ...
    #     if self.progress_value <= 20:  # Assuming 20 steps for 2 seconds delay
    #         # Update the progress bar value
    #         self.progressBar.setValue(self.progress_value * 5)  # Each step is 5% of the progress bar

    #     else:
    #         # Stop the delay timer and reset progress value
    #         self.delay_timer.stop()
    #         self.progress_value = 0
            
    #         # Display the mixed array
    #         self.display_mixed_array(self.mixed_array)
